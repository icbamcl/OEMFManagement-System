<%@ Page Language="C#"   MasterPageFile ="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitRepurchaseChequeDelivery.aspx.cs" Inherits="UI_UnitRepurchaseChequeDelivery" Title="Unit Repurchase Cheque Delivery Form (Design and Developed by Sakhawat)" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager runat="Server" 
        ...
        <tr>
           ...
           Unit Holder Repurchase Cheque Delivery&nbsp; Form (<span id="spanFundName" runat="server"></span>)
            </td>           
            <td>
                <br />
            </td>
                            ...
                            <tr>
                                <td align="left" > 
                                     <div ID="dvLedger" runat="server" 
                                        style="text-align: left; display: block; padding-left:20px;" class="auto-style2">
                                       
                                        <asp:DataGrid ID="dgLedger" runat="server" AutoGenerateColumns="False" 
                                            BorderColor="Black" CellPadding="1" CellSpacing="1" 
                                            meta:resourcekey="dgLedgerResource1" Width="1091px" >
                                            ...
                                            <Columns>
                                             ...
                                             <ItemTemplate> 
                                              ...
                                              <asp:BoundColumn DataField="REG_BK" HeaderText="Fund Code">                                                   
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="REG_BR" HeaderText="Branch Code">                                                   
                                                </asp:BoundColumn>                                               
                                                <asp:BoundColumn DataField="REG_NO" HeaderText="Reg. No ">                                                   
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="REP_NO" HeaderText="Repurchase No.">                                                   
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="QTY" HeaderText="No of Unit">                                                   
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="REP_PRICE" HeaderText="Rate">                                                                                                        
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="CHQ_INFO" HeaderText="Cheque Info.">                                                                                                        
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="CHQ_RECEIVED_INFO" HeaderText="Cheque Receive Info.">                                                                                                        
                                                </asp:BoundColumn>
