<%@ Page Language="C#" MasterPageFile="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitSIPEntry.aspx.cs" Inherits="UI_UnitSIPEntry" Title="Registration Entry Form (Design and Developed by Sakhawat)" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     ...
     function fnReset()
    {
        ...
        if(confirm)
        {
            ...
            document.getElementById("<%=sipNumberTextBox.ClientID%>").value = "";
     ...
     function fnCheqInput()
        {                
         ...
         if (document.getElementById("<%=sipNumberTextBox.ClientID%>").value == "")
            {
                document.getElementById("<%=sipNumberTextBox.ClientID%>").focus();
                alert("Please Enter SIP Number");
                return false;
         ...
         if (document.getElementById("<%=sipNumberTextBox.ClientID%>").value != "")
            {
                var digitCheck = /^\d+$/;
                if(!digitCheck.test(document.getElementById("<%=sipNumberTextBox.ClientID%>").value))
                {
                    document.getElementById("<%=sipNumberTextBox.ClientID%>").focus();
                    alert("Please Enter Numaric value for SIP Number");
                    return false;
                }
         }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager runat="Server" 
        ...
        Unit Holder SIP Entry Form (<span id="spanFundName" runat="server"></span>)
            </td>           
 ...
 <tr>
                ...
                <tr>
                    ...
                    <td style=" background-color: #547DD3; "  id="tdSIP" runat="server">
                        <span class="style3">|</span><asp:HyperLink ID="HyperLink2" runat="server" 
                            NavigateUrl="~/UI/UnitSIPEntry.aspx" Font-Bold="True" ForeColor="White">SIP Information</asp:HyperLink>
                    </td >
    ...
    <tr>
       ...
       <td align="left">
        ...
        <td align="right" >
            <b>&nbsp;SIP Number:</b></td>
       <td align="left">
            <asp:TextBox ID="sipNumberTextBox" runat="server" 
  ...
  <tr>
    ...
    <tr>
        <td colspan="4" align="left">
         <fieldset>
            ...
            <asp:ListItem Value="3" Selected="True">Savings</asp:ListItem>                     
            </asp:DropDownList> </strong> <span class="star">*</span></td>
                    <td align="right" >  &nbsp;</td>
                    <td align="left">
                        &nbsp;</td>
    ...
    <table width="500" align="center" cellpadding="0" cellspacing="0">
     ...
     <tr>
        <td align="right">
        <asp:Button ID="regSaveButton" runat="server" Text="Save and Print" CssClass="auto-style7" OnClientClick="return fnCheqInput();"
                onclick="regSaveButton_Click" TabIndex="41" AccessKey="s" Width="111px" 
                />&nbsp;
        </td>
        <td align="left">&nbsp;&nbsp;&nbsp;
