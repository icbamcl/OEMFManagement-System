<%@ Page Language="C#" MasterPageFile="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitSIPReportStatement.aspx.cs" Inherits="UI_UnitSIPReportStatement" Title=" SIP Statement Report(Design and Developed by Sakhawat)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   ...
   function fnReset()
   {
        ...
        document.getElementById("<%=fromSIPDateTextBox.ClientID%>").value ="";
        document.getElementById("<%=toSIPDateTextBox.ClientID%>").value ="";
 ...
 function fncInputNumericValuesOnly()
	...
	function fnOnChangeText1()
     ...
     {                                
         document.getElementById("<%=toSIPDateTextBox.ClientID%>").value=document.getElementById("<%=fromSIPDateTextBox.ClientID%>").value;                                                                           
         document.getElementById("<%=toSIPDateTextBox.ClientID%>").focus();    
     }
    ...
    <ajaxToolkit:ToolkitScriptManager runat="Server" EnableScriptGlobalization="true"
      ...
      <tr>
            <td class="FormTitle" align="center"  colspan="3">
                Unit SIP Statement Before Sale Issue Report Form (<span id="spanFundName" runat="server"></span>)
            </td>           
      ...
      <tr>
        ...
        <td align="left" colspan="2" class="auto-style2">
            <asp:RadioButton ID="ackSIPRadioButton" runat="server" Font-Bold="True" GroupName="sipHolder" Text="SIP Acknowledgement" Checked="True" />
