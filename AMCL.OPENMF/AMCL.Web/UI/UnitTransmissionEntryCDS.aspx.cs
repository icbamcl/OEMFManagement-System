...
public partial class UI_UnitTransmissionEntryCDS : System.Web.UI.Page
{
    ...
    protected void tferorRegNoTextBox_TextChanged(object sender, EventArgs e)
    {
        ...
        if (dtRegInfo.Rows.Count > 0)
        {
            ...
            {
                transferNoTextBox.Text = unitTransferBLObj.getNextTransferNo(unitRegObj, userObj,"D").ToString();
    ...
    protected void SaveButton_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else if (unitTransferBLObj.IsDuplicateTransfer(regObj, transferObj, "D"))
            {
