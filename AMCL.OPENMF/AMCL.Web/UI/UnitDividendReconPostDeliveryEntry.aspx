<%@ Page Language="C#" MasterPageFile="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitDividendReconPostDeliveryEntry.aspx.cs" Inherits="UI_UnitDividendReconPostDeliveryEntry" Title=" Unit Dividend Reconcile (Design and Developed by Jagonnath)" %>
  ...
  function fnReset()
    {
        ...
        {         
            ...
            document.getElementById("<%=fyDropDownList.ClientID%>").value ="0";
        ...
        function fnCheqInput()
        {
            ...
            if(document.getElementById("<%=fyDropDownList.ClientID%>").value =="0")
                {   
          
                        document.getElementById("<%=fyDropDownList.ClientID%>").focus();
         ...
         function myDisable() {
         document.getElementById("<%=warrantNosTextBox.ClientID%>").disabled = true; 
       }
   function myEnable() {
         document.getElementById("<%=warrantNosTextBox.ClientID%>").disabled = false;            
   }
     ...
     <table align="center">
            <tr>
                <td class="FormTitle" align="center">
                                    ...
                                    Warrant Post Delivery Entry Form 
                </td>           
            </tr> 
          </table>
    <br />
...
<colgroup width="220"></colgroup>
    ...
    <tr>
        ...
        <td align="left"><asp:DropDownList ID="fyDropDownList" runat="server" TabIndex="1" OnSelectedIndexChanged="fyDropDownList_SelectedIndexChanged" AutoPostBack="True" ></asp:DropDownList><span class="auto-style4">*</span></td>
    </tr>
    <tr >
     ...
     <tr>
        <td align="right" ><b>Post Details:</b></td>
        <td align="left"><asp:TextBox ID="PostDetailsTextBox" runat="server" 
                CssClass= "TextInputStyleLarge" MaxLength="120" TabIndex="27" 
                meta:resourcekey="nomi1Address1TextBoxResource1"></asp:TextBox><span class="auto-style4">*</span></td>
    </tr>
    <tr>
        <td align="right"></td>

         <td  align="left">
             <asp:RadioButton ID="BEFTNReturnWarrentRadioButton" runat="server" Checked="True" Font-Bold="True" GroupName="PostDeliveryType" Text="BEFTN Return Warrent" onclick="myEnable()"/> 
             <asp:RadioButton ID="NONBEFTNWarrentRadioButton" runat="server"  Font-Bold="True" GroupName="PostDeliveryType" Text="NON BEFTN Warrent" onclick="myDisable()"/>            
        </td>
   </tr>
...
&nbsp;(1,2,3):</b></td>
    ...
    <tr>
        ...
        <td align="left">
            &nbsp;<asp:Button 
                ID="saveButton" runat="server" CssClass="auto-style3" Text="Save" OnClientClick="return fnCheqInput();" 
