<%@ Page Language="C#"   MasterPageFile ="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitTransmissionEntry.aspx.cs" Inherits="UI_UnitTransmissionEntry" Title=" Unit Transmission Entry (Design and Developed by Sakhawat)" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager runat="Server" EnableScriptGlobalization="true"
        ...
        <tr>
           ...
           Unit Holder Death Transmission Entry Form (<span id="spanFundName" runat="server"></span>)
            </td>           
            <td>
                <br />
            </td>
