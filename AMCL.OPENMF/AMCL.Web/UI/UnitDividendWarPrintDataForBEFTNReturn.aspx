<%@ Page Language="C#" MasterPageFile="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitDividendWarPrintDataForBEFTNReturn.aspx.cs" Inherits="UI_UnitDividendReconPostReturnEntry" Title=" Unit Dividend Reconcile (Design and Developed by Jagonnath)" %>
  ...
  function fnReset()
    {
        ...
        function fnCheqInput()
        {
           ...
           if(document.getElementById("<%=ClosingDateDropDownList.ClientID%>").value =="0")
                {   
     ...
     <table align="center">
            <tr>
                <td class="FormTitle" align="center">
                                    &nbsp;Dividend  
                                    Warrant Print for BEFTN Return Form 
                </td>           
            </tr> 
          </table>
    <br />
...
&nbsp;(1,2,3):</b></td>
    ...
    <tr>
        ...
        <td align="left">
            &nbsp;<asp:Button 
                ID="saveButton" runat="server" CssClass="auto-style3" Text="Export File" OnClientClick="return fnCheqInput();" 
