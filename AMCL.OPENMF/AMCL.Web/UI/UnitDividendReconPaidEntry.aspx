<%@ Page Language="C#" MasterPageFile="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitDividendReconPaidEntry.aspx.cs" Inherits="UI_UnitDividendReconPaidEntry" Title=" Unit Dividend Reconcile (Design and Developed by Jagonnath)" %>
     ...
     <table align="center">
            <tr>
                <td class="FormTitle" align="center">
                                    &nbsp;Dividend Reconsiliation Warrant Paid Entry Form 
                </td>           
            </tr> 
          </table>
    <br />
...
<colgroup width="220"></colgroup>
    ...
    <tr>
        ...
        <td align="left">               
            <asp:DropDownList ID="fyDropDownList" runat="server"   
               
              TabIndex="1" AutoPostBack="True" OnSelectedIndexChanged="fyDropDownList_SelectedIndexChanged" ></asp:DropDownList>
                                    <span class="auto-style4">*</span></td>
    </tr>
      <tr >
...
&nbsp;(1,2,3):</b></td>
        <td align="left" class="style6">               
            <asp:TextBox ID="warrantNosTextBox" runat="server"  
                    CssClass= "auto-style1" TabIndex="3" Width="601px" 
                  Height="80px" TextMode="MultiLine" ></asp:TextBox>&nbsp;<span class="auto-style4">*</span>
                </td>
    </tr>
    ...
    <tr>
        ...
        <td align="left">
            &nbsp;<asp:Button 
                ID="saveButton" runat="server" CssClass="auto-style3" Text="Save for Paid"  OnClientClick="return fnCheqInput();" 
                onclick="saveButton_Click" Width="116px" Height="27px" />
            &nbsp;&nbsp;<asp:Button ID="resetButton" runat="server" CssClass="auto-style3" 
               OnClientClick="return fnReset();" Text="Reset" OnClick="resetButton_Click" Height="27px" />
&nbsp;
            <asp:Button ID="CloseButton" runat="server" CssClass="auto-style3" 
                 Text="Close" 
                onclick="CloseButton_Click" TabIndex="8" Height="26px" />
        </td>
    </tr>
    <tr>
            <td colspan="2">&nbsp;</td>
