<%@ Page Language="C#" MasterPageFile="~/UI/UnitCommon.master" AutoEventWireup="true" CodeFile="UnitDividendReconBEFTNReturnEntry.aspx.cs" Inherits="UI_UnitDividendReconBEFTNReturnEntry" Title=" Unit Dividend Reconcile (Design and Developed by Jagonnath)" %>
    ...
    <tr>
        ...
        <td align="left">               
            <asp:DropDownList ID="fyDropDownList" runat="server"   
              ...
              TabIndex="1" OnSelectedIndexChanged="fyDropDownList_SelectedIndexChanged" AutoPostBack="True" ></asp:DropDownList>
                                    <span class="auto-style4">*</span></td>
    </tr>
