...
namespace AMCL.COMMON
{
    public class ConfigReader
    {
        ...
        public static string SipEftPaidFileLocation
        {
            get
            {

                if (System.Configuration.ConfigurationManager.AppSettings[AppConstants.CONN_STRING_SipEftPaidFileLocation] != null)
                {
                    return System.Configuration.ConfigurationManager.AppSettings[AppConstants.CONN_STRING_SipEftPaidFileLocation];
                }
                return "";
            }
        }
        public static string DividendCDBLFile
        {
            get
            {

                if (System.Configuration.ConfigurationManager.AppSettings[AppConstants.CONN_STRING_DividendCDBLFile] != null)
                {
                    return System.Configuration.ConfigurationManager.AppSettings[AppConstants.CONN_STRING_DividendCDBLFile];
                }
                return "";
            }
        }
